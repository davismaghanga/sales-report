                ...
                <div   id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                            <li><a href="{{url('home')}}"><i class="fa fa-home"></i> HOME (regmanager)</a>
                            ...
                            <li><a><i class="fa fa-globe"></i> Regions <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    ...
                                    <li> <a href="{{url('manager/view/regions')}}"> <i class="fa fa-globe"></i> View All regions</a></li>

                                    {{--edit a subregion and delete--}}
                                    <li> <a href="{{url('manager/view/counties')}}"> <i class="fa fa-globe"></i> View All Counties</a></li>
                                    <li> <a href="{{url('manager/view/subcounties')}}"> <i class="fa fa-globe"></i> View All Sub Counties</a></li>
