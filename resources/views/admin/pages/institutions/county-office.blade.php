                            ...
                            <table id="datatable" class="table table-striped table-bordered">
                                ...
                                @foreach($counties as $county)
                                    <tr class="even pointer">
                                        ...
                                        <td class=""> {{$county->id}}</td>
                                        <td class=""> {{$county->institution_name}}</td>
                                        <td class=""> {{$county->activity}}</td>
                                        <td class=""> {{$county->upcoming}}</td>
                                        <td class=""> {{$county->outcome}}</td>

                                        @if($county->orders != null)
                                            <td class=""> {{$county->orders}}</td>
                                        @else
